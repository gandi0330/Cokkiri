...
//         <input placeholder="인증번호를 입력해 주세요." name="number" id="number" 
//          value={certificateNumber} 
//          onChange={certificateNumberChangeHandler} 
//          onBlur={certificateNumberBlurHandler} maxLength={6} />
//       </div>
...
//  <Timer min={3} sec={0} onTimerZero={onTimerZero} /></span>
//   //       <label htmlFor="number">인증번호</label>
//   //       <input placeholder="인증번호를 입력해 주세요." name="number" 
//   //       id="number" value={certificateNumber} onChange={certificateNumberChangeHandler} 
//   //       onBlur={certificateNumberBlurHandler} maxLength={6} />
//   //     </div>
